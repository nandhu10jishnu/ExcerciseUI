<template>
  ...
  <label class="form-check-label" for="flexCheckIndeterminate">
    Active
      ...
      <div class="col-4">
        <button type="button" class="btn btn-primary"  @click.prevent="saveDesignation">Create Designation</button>
      </div>
    </div>
  </div>
</template>
  <script src="../createdesignation/CreateDesignation.js"></script>
